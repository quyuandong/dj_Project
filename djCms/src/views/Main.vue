<template>
  <body>
    <div class="datouwang">
      <div style="font-size:30px;"><span>欢迎进入</span><span>&nbsp;党建e家</span></div>
      <div class="arms">
...
body {
  ...
  background: linear-gradient(#fff, #ccffff, #fff);
}
...
.datouwang .guts {
  ...
  top: 1em;
  border-radius: 50%;
  box-shadow: -1.5em 0.7em 0 -0.8em white, -1.7em -0.5em 0 -1.4em white,
    1.8em -0.1em 0 -1.3em white, 1em 1em 0 -0.6em white,
    -0.4em 1.8em 0 -1.3em white, 1.4em -1em 0 -1.5em white,
