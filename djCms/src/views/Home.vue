	...
	<el-row class="container">
		...
		<el-col :span="24" class="header">
			...
			<el-col :span="6" class="logo" :class="collapsed? 'logo-collapse-width':'logo-width'">
				<img v-show="!collapsed" style="width:100px;height: 40px;padding-left:35px" src="../../static/1.png" alt="">
			</el-col>
			...
			<el-col :span="10"  class="header_title">
				党建e家&nbsp;&nbsp;后台管理系统
			</el-col>
			...
			<el-col :span="6" class="userinfo">
				<el-dropdown trigger="hover">
					<span class="el-dropdown-link userinfo-inner">
						<img src="../../static/header.jpg" /> 用户名：admin
					</span>
		...
		<el-dialog title="修改密码" :visible.sync="dialogFormVisible" :close-on-click-modal="false">
			<el-form :model="pform" >
				<el-form-item label="新密码" label-width="50">
					<el-input v-model="pform.data1" type="password" autocomplete="off"></el-input>
				</el-form-item>

				<el-form-item label="确认密码" label-width="50" >
					<el-input type="password" v-model="pform.data2" autocomplete="off"></el-input>
				</el-form-item>
			</el-form>
						...
						<template v-if="!item.leaf">
							...
							<ul class="el-menu submenu" :class="'submenu-hook-'+index"
								...
								<li v-for="child in item.children"
									v-if="!child.hidden" :key="child.path" class="el-menu-item"
...
<script>
	...
	export default {
		...
		methods: {
            // 提交新密码
            submitNewPwd() {
                if (this.pform.data1 != this.pform.data2) {
                    this.$message.error("两次密码输入不一致");
                } else {
                    changePwd({ newPwd: this.pform.data1 }).then(res => {
                        console.log(res);
			...
			logout: function () {
				...
				this.$confirm('确认退出吗?', '提示', {
                    ...
                    localStorage.removeItem("dj_login");
